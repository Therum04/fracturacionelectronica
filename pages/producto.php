    ...
    <div class="bg-white p-6 rounded-xl shadow mb-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Gestión de productos del sistema</p>
            </div>
...
<div id="productoModal"
    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md mx-4">
        ...
        <!-- Body -->
        <div class="p-6">
            <form id="form_producto" class="grid grid-cols-1 gap-4">
                ...
                <div>
                 ...
                 <div>
                    ...
                    <select name="id_unidad" id="id_unidad"
                        class="mt-1 w-full border border-gray-300 rounded px-3 py-2 text-gray-900
                               focus:outline-none focus:ring focus:border-blue-400 bg-white tipoUnidadMedida_list">
                    </select>
                </div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700">
                        Tipo impuesto <span class="text-red-500">*</span>
                    </label>
                    <select name="id_impuesto" id="id_impuesto"
                        class="mt-1 w-full border border-gray-300 rounded px-3 py-2 text-gray-900
                               focus:outline-none focus:ring focus:border-blue-400 bg-white tipoInpuesto_list">
                    </select>
                </div>
